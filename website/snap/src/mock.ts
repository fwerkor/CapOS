...
export const mockStorefront: StorefrontData = {
  ...
  apps: [
    { id: 'nextcloud', name: 'nextcloud', displayName: 'Nextcloud', publisher: 'Nextcloud', summary: 'A safe home for all your data.', description: 'Access and collaborate across your devices with a private productivity platform.', category: 'Productivity', accent: '#1976d2', source: 'upstream', sourceName: 'Canonical', verified: true, featured: true, version: '31.0.8', channel: 'stable', architectures: ['amd64', 'arm64'], webdesktop: 'web', rating: 4.8, downloads: '2.4M', updated: '2 days ago' },
